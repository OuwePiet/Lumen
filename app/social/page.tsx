...
const futureIdeas = [
  { title: "External creator collectible intake", text: "Evaluate a paid public creator route for preparing media and collectible metadata without operating a VIA blockchain or node. Any external item shown in VIA must carry a clear External collectible label; native on-chain items keep the DeSo NFT label. Purchase, ownership and conversion to a DeSo NFT require a separately verified flow before release." },

...
const copies: Record<ViaLanguage, Copy> = {
  ...
  Hindi: {
    title: "मेरा वॉलेट",
    intro: "VIA से वर्तमान में जुड़े DeSo खाते की केवल-पढ़ने योग्य वॉलेट जानकारी।",
    back: "मेरे VIA पर वापस जाएँ",
    noAccount: "कोई DeSo खाता जुड़ा नहीं है",
    noAccountText: "DeSo Identity से लॉग इन करने के लिए ऊपर VIA खाता बटन का उपयोग करें।",
    loading: "वॉलेट लोड हो रहा है…",
    unavailable: "वॉलेट बैलेंस अभी उपलब्ध नहीं है।",
    stale: "अंतिम उपलब्ध वॉलेट डेटा दिखाया जा रहा है।",
    available: "उपलब्ध बैलेंस",
    updated: "अंतिम अपडेट",
    rate: "VIA की वर्तमान DESO संदर्भ दर पर",
    creatorCoins: "creator coins",
    bought: "खरीदे गए",
    received: "प्राप्त",
    balanceNote: "बैलेंस सीधे DeSo से पढ़े जाते हैं। VIA इन फंड्स या coins को अपने पास नहीं रखता।",
    boughtTitle: "Creator coins · खरीदे गए",
    receivedTitle: "Creator coins · प्राप्त",
    emptyCoins: "इस श्रेणी में कोई creator coins नहीं हैं।",
    publicKey: "पब्लिक की",
    copied: "कॉपी किया गया",
    copyKey: "पब्लिक की कॉपी करें",
    boundary: "वॉलेट सीमा",
    boundaryText: "यह पेज जानबूझकर केवल-पढ़ने योग्य है। भेजना, खरीदना, swap और निकासी तब तक उपलब्ध नहीं होंगे जब तक प्रत्येक लेन-देन प्रवाह को DeSo Identity की मंजूरी के साथ अलग से सत्यापित न किया जाए।",
    coins: "coins",
  },
}

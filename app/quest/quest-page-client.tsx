...
const COPY: Record<ViaLanguage, QuestCopy> = {
  ...
  Hindi: {
    navigation: "World Quest नेविगेशन",
    discovery: "दुनिया खोजें",
    radio: "वर्ल्ड रेडियो",
    saved: "सहेजा गया",
    free: "मुफ़्त",
    heroTitle: "दुनिया खेलें। DeSo खोजें।",
    heroText: "छोटे खोज मार्ग पूरे करें, VIA Points इकट्ठा करें और अपनी स्ट्रीक बनाएँ। पहला खेलने योग्य संस्करण केवल पढ़ने के लिए है और इसमें कभी seed phrase या wallet signing की आवश्यकता नहीं होती।",
    games: "VIA GAMES",
    pick: "एक VIA गेम चुनें",
    pickText: "सीधे किसी गेम में जाएँ। नीचे दिए गए सभी गेम मुफ़्त हैं; साझा करना और सहेजना वैकल्पिक है। सहेजे गए गेम इसी ब्राउज़र में रहते हैं।",
    descriptions: [
      "एक छोटा दैनिक दिमागी खेल।",
      "अक्षरों की श्रृंखला चलती रखें।",
      "तेज़ स्थानीय आर्केड खेल।",
      "तीन परतों वाली सजी हुई टाइल स्टैक साफ़ करें।",
      "UV संकेतों से तीन रहस्यमय यांत्रिक तिजोरियाँ खोलें।",
      "तीन हल्के VIA कॉफी मिनी गेम।",
      "500 टुकड़ों तक की चेन इमेज फिर से बनाएँ।",
      "मार्गों के ज़रिए VIA और DeSo खोजें।",
    ],
    rewardTitle: "कोई वित्तीय गेम पुरस्कार नहीं",
    rewardText: "VIA World Quest गेम खेलने, खोजने और वैकल्पिक स्थानीय प्रगति के लिए सामान्य मनोरंजन अनुभव हैं। स्कोर, स्ट्रीक, VIA Points और सहेजी गई गेम स्थिति का कोई नकद मूल्य नहीं है और वे DESO, Diamonds, tokens, भुगतान या किसी अन्य वित्तीय पुरस्कार का अधिकार नहीं देते। गेम गतिविधि कभी भी अपने-आप कोई on-chain भुगतान या पुरस्कार शुरू नहीं करती।",
    coffeeActions: "VIA Coffee Corner गेम साझा करें या सहेजें",
  },
}

    ...
    <div data-via-collection-page style={{ minHeight: "100vh", overflow: "hidden", position: "relative", background: "#050807" }}>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        <section style={{ maxWidth: 1480, margin: "0 auto", padding: "22px 20px 4px" }} aria-label="NFT hub">
          <div style={{ border: "1px solid rgba(143,212,169,.24)", borderRadius: 16, background: "rgba(5,16,10,.72)", padding: 16 }}>
            ...
            <p style={{ margin: "0 0 14px", color: "#9eaaa3", fontSize: 14, lineHeight: 1.55 }}>Browse collections, create and mint, buy or sell, manage bids and follow transfers without separate homepage groups.</p>

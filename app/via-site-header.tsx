    ...
    <header style={styles.header} className="via-site-header">
      ...
      <style>{`
        ...
        @media (max-width: 720px) {
          ...
          .via-site-header-tools-notifications { grid-column: 2 !important; grid-row: 1 !important; align-self: center !important; padding: 6px 100px 6px 0 !important; overflow: visible !important; }

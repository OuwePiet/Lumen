    ...
    <header style={styles.header} className="via-site-header">
      <div style={styles.shell} className="via-site-header-shell">
        ...
        <div style={styles.toolsRow} className={`via-site-header-tools ${pathname === "/notifications" || pathname === "/radio" || pathname === "/messages" || pathname === "/profile" ? "via-site-header-tools-notifications" : ""} ${pathname === "/messages" ? "via-site-header-tools-messages" : ""}`} aria-label="VIA utility controls">
          ...
          {pathname === "/messages" ? <Link href="/radio" className="via-notifications-radio-top" aria-label="World Radio" title="World Radio"><RadioTower className="h-4 w-4" aria-hidden="true" /></Link> : null}
      ...
      <style>{`
        ...
        @media (max-width: 720px) {
          ...
          .via-site-header-tools-notifications > .via-notifications-home-top {

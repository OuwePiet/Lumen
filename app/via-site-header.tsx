    ...
    <header style={styles.header} className="via-site-header">
      ...
      <style>{`
        ...
        @media (max-width: 720px) {
          ...
          .via-site-header-tools-notifications { position: absolute !important; left: 88px !important; right: 10px !important; top: 4px !important; height: 44px !important; grid-column: auto !important; grid-row: auto !important; align-items: flex-start !important; justify-content: space-between !important; gap: 0 !important; padding: 0 !important; overflow: visible !important; }\n          .via-site-header-tools-notifications .via-notifications-top-control, .via-site-header-tools-notifications .via-site-header-language-wrap { display: flex !important; flex: 0 0 42px !important; flex-direction: column !important; align-items: center !important; gap: 1px !important; }\n          .via-site-header-tools-notifications .via-notifications-top-label { display: block !important; color: #8b9890 !important; font-size: 8px !important; line-height: 10px !important; white-space: nowrap !important; }

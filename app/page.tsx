...
const styles = {
  ...
  quiet: { color: "#88978f" },
  stage: {
    minHeight: "clamp(650px, 69vw, 820px)",
    position: "relative" as const,
    overflow: "hidden",
  },
  shell: {
  ...
  actionIcon: { color: "#91ddb1", fontSize: "18px", width: "23px", textAlign: "center" as const },
  hero: {
    position: "relative" as const,
    zIndex: 4,
    maxWidth: "900px",
  ...
  kicker: {
    margin: "0 auto 16px",
    color: "#75d59e",
    fontSize: "clamp(11px, 1.12vw, 14px)",
    fontWeight: 650,
    letterSpacing: ".27em",
    lineHeight: 1.75,
  ...
  title: {
    margin: 0,
    color: "#f2f5f3",
    fontSize: "clamp(31px, 3.75vw, 48px)",
    fontWeight: 500,
    letterSpacing: "-.03em",
    lineHeight: 1.06,

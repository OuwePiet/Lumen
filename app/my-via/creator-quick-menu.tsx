...
const copy: Record<ViaLanguage, Copy> = {
  ...
  Hindi: {
    kicker: "स्थानीय शॉर्टकट",
    heading: "क्रिएटर क्विक मेनू",
    intro: "उन सार्वजनिक DeSo क्रिएटर्स की छोटी सूची रखें जिन्हें आप जल्दी फिर से देखना चाहते हैं। VIA सहेजने से पहले जाँचता है कि प्रोफ़ाइल मौजूद है। यह संस्करण केवल इसी ब्राउज़र में रहता है, कोई DeSo लेन-देन नहीं करता और यह साबित नहीं करता कि सहेजा गया खाता आपके नियंत्रण में है। अलग-अलग डिवाइस के बीच सिंक बाद का अलग चरण रहेगा।",
    inputLabel: "DeSo क्रिएटर उपयोगकर्ता नाम",
    placeholder: "DeSo उपयोगकर्ता नाम, @ के साथ या बिना",
    checking: "जाँच हो रही है…",
    add: "क्रिएटर जोड़ें",
    listLabel: "सहेजे गए क्रिएटर शॉर्टकट",
    remove: "हटाएँ",
    empty: "अभी कोई स्थानीय क्रिएटर शॉर्टकट नहीं है।",
    readError: "इस ब्राउज़र से आपके स्थानीय क्रिएटर शॉर्टकट पढ़े नहीं जा सके।",
    saveError: "इस विज़िट के लिए शॉर्टकट बदल गया, लेकिन स्थानीय रूप से सहेजा नहीं जा सका।",
    enterFirst: "पहले DeSo उपयोगकर्ता नाम दर्ज करें।",
    already: "@{name} पहले से आपके क्विक मेनू में है।",
    limit: "यह स्थानीय क्विक मेनू अधिकतम {max} क्रिएटर्स तक सीमित है।",
    checkingName: "DeSo पर @{name} की जाँच हो रही है…",
    notVerified: "@{name} को सार्वजनिक DeSo प्रोफ़ाइल के रूप में सत्यापित नहीं किया जा सका, इसलिए इसे सहेजा नहीं गया।",
    saved: "@{name} को DeSo पर सत्यापित किया गया और इस डिवाइस पर स्थानीय रूप से सहेजा गया।",
    checkError: "अभी DeSo प्रोफ़ाइल की जाँच नहीं की जा सकी। कुछ भी सहेजा नहीं गया।",
    removed: "@{name} को इस स्थानीय क्विक मेनू से हटा दिया गया।",
  },
}

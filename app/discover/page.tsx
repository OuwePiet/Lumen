  ...
  return (
    <main style={styles.main}>
      <div style={styles.shell}>
        ...
        <section style={styles.grid} aria-label={`${visibleOpenCreatorWindows} open creator discovery windows`}>
          {orderedCreatorWindows.length === 0 && <p style={styles.cardText}>No creator windows match this filter yet. Choose ALL to continue exploring.</p>}

  ...
  return (
    <main style={styles.main}>
      <div style={styles.shell}>
        ...
        <p style={{ ...styles.cardText, marginBottom: "12px" }} aria-live="polite">{selectedKind ? `Showing ${selectedKind.toUpperCase()} creator windows` : "Showing all creator windows"}</p>

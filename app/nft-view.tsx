...
const styles = {
  page: {
    ...
    backgroundImage: 'linear-gradient(180deg, rgba(3,7,5,.48) 0%, rgba(3,7,5,.72) 46%, rgba(3,7,5,.9) 100%), url("/via-nft-background-approved.webp")',
  ...
  badge: {
    display: "inline-block",
    color: "#8fd4a9",
    background: "rgba(12,23,17,.45)",
    border: "1px solid rgba(143,212,169,.3)",
    borderRadius: "9px",
    fontSize: "11px",
    fontWeight: 700,
    padding: "5px 8px",
  ...
  hash: {
    marginTop: "22px",
    paddingTop: "18px",
    borderTop: "1px solid rgba(63,74,68,.55)",
  },
  code: {
    display: "block",
    color: "#a9b8af",
